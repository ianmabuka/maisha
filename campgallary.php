...
<?php include('admin/function.php'); ?>
  ...
  <nav class="vertical_nav">
    ...
    <ul id="js-menu" class="menu">
      ...
      <li class="menu--item">
        <a href="camps.php" class="menu--link link__active" title="Active and complete camps">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-4 col-6">
            <a href="admin/pic/<?php  echo $data[3] ?>" data-lightbox="Gallery" data-title="Gallery" class="d-block mb-4 h-100">
              <div class="card-box-b card-shadow">
                <div class="img-box-a">
                  <img src="Admin/pic/<?php  echo $data[3] ?>" alt="<?php  echo $data[2] ?>" class="img-b img-fluid">
                </div>
