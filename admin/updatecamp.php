      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Update Camp</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Update Camp</h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Update Camp</h6>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Select Camp:</label>
                        <div class="col-sm-7">
                            <select class="form-control" required="required" name="s3">
                        ...
                        <div class="col-sm-2">
                         <input class="form-control btn-primary" type="submit" value="Show" name="show" formnovalidate="formnovalidate" />   
                        </div>
                        <?php
                        if(isset($_POST["show"]))
                        {
                    ...
                    <div class="form-group row"> 
                       <label class="col-sm-3 col-form-label" >Camp Title:</label> 
                       <div class="col-sm-9"> 
                            <input type="text" class="form-control" value= "<?php if(isset($_POST["show"])){echo $camp_title;} ?>" name="t3" required="required"> 
                       </div> 
                    </div> 
                    <div class="form-group row"> 
                       <label class="col-sm-3 col-form-label" >Organizer:</label> 
                       <div class="col-sm-9">
                        <input type="text" class="form-control" value="<?php if(isset($_POST["show"])){echo $organized_by;} ?>" name="t2" required="required"> 
                       </div> 
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">From Date:</label>
                            <div class="col-sm-9">
                                 <input type="date" class="form-control" name="t5" value= "<?php if(isset($_POST["show"])){echo $fromdate;} ?>" required="required">   
                            </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">To Date:</label>
                            <div class="col-sm-9">
                                 <input type="date" class="form-control" name="t6" value= "<?php if(isset($_POST["show"])){echo $todate;} ?>" required="required">   
                            </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Camp Image:</label>
                        <div class="col-sm-9">
                            <img src="pic/<?php echo @$pic; ?>" name="h1" class="camp-img" alt="Camp Image">
                            <input type="hidden" class="form-control" name="h1" value="<?php if(isset($_POST["show"])){echo $pic;} ?>">  
                        </div>
                    </div>
                    <div class="form-group row"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             <textarea class="form-control" rows="3" name="t4"><?php if(isset($_POST["show"])){echo $detail;} ?></textarea>   
                        </div>
                    </div>
                
                </div>
                <div class="card-footer d-flex justify-content-center">
                 <input type="submit" name="sbmt" value="Update" class="btn btn-warning">      
                </div>
                </form>
                <?php
                if(isset($_POST["sbmt"])) 
                ...
                if (empty($_FILES['t1']['name'])) {
                   $s="UPDATE camp SET camp_title='" . $_POST["t3"] . "',organised_by='" .$_POST["t2"] . "',state='" .$_POST["s1"] ."',city='" .$_POST["s2"] ."',fromdate='" .$_POST["t5"] . "',todate='" .$_POST["t6"] . "',pic='" . $_POST["h1"] . "',detail='" . $_POST["t4"] ."' WHERE camp_id='".$_POST["s3"] ."'";
                }
                else
                {
                    $s="UPDATE camp SET camp_title='" . $_POST["t3"] . "',organised_by='" .$_POST["t2"] . "',state='" .$_POST["s1"] ."',city='" .$_POST["s2"] ."',fromdate='" .$_POST["t5"] . "',todate='" .$_POST["t6"] . "',pic='" .basename($_FILES["t1"]["name"]). "',detail='" . $_POST["t4"] ."' WHERE camp_id='".$_POST["s3"] ."'";
                }
                    $i=mysqli_query($cn,$s);
                    mysqli_close($cn);

                    echo "<script>alert('Camp updated');</script>";
