      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            {?> 
            <a class="collapse-item active" href="#">Add User</a>
            <?php }?>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t1" required="required" pattern="[a-zA-Z _]{3,15}" title="A minimum of 3 and maximum of 15 characters" placeholder="User Name">   
                        </div>
                    </div>
                    <div class="form-group row"> 
                       <label class="col-sm-3 col-form-label" >Password:</label> 
                       <div class="col-sm-9"> 
                            <input type="password" class="form-control" name="t2" required="required" placeholder="Password"> 
                       </div> 
                    </div> 
                    <div class="form-group row"> 
                       <label class="col-sm-3 col-form-label" >Confirm Password:</label> 
                       <div class="col-sm-9">
                        <input type="password" class="form-control" name="t3" required="required" placeholder="Confirm Password"> 
                       </div> 
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row"> 
                           <label class="col-sm-3 col-form-label" >Display Image:</label>  
                           <div class="col-sm-9"> 
                               <div class="input-group form-group">
                                  <div class="input-group input-file" name="t4">
                ...
                //aloow certain file formats
                    if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
                        ...
                        $s="insert into users(username,pwd,typeofuser,pic) values('" . $_POST["t1"] ."','" . $_POST["t2"] . "','" . $_POST["s1"] . "','" . basename($_FILES["t4"]["name"]) . "')";
                    mysqli_query($cn,$s);
                    mysqli_close($cn);
            ...
            <div class="col-xl-4 col-lg-5 mb-4">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Total Admin Users </h6>
                </div>
                <div class="card-body">
                    <div class="card mb-3 border-left-success">
                        <div class="card-body row align-items-center">
                            <div class="col">
                                <div class="h4 mb-1 font-weight-bold text-success">~ 5</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-sitemap fa-2x text-gray-400"></i>
                            </div>
                        </div>
                    </div>   
                    <table class="table table-hover">
                        ...
                        <?php
                            ...
                            while($data=mysqli_fetch_array($result))
                            {
                                echo"<tr><td>$data[0]</td><td>$data[2]</td></tr>";
                            }
                                mysqli_close($cn);
                            ?>       
                        </tbody>
