      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Add Camp</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Camp</h1>
          </div>
          ...
          <div class="row">
              ...
              <div class="card shadow mb-4">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-primary">Add Camp</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <input type="submit" class="form-control btn-primary" value="Get Cities" name="show"  formnovalidate="formnovalidate">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                 <input type="text" class="form-control" name="t1" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 30 characters" placeholder="Camp title">   
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Organized By:</label>
                            <div class="col-sm-9">
                                 <input type="text" class="form-control" name="t2" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 10 characters" placeholder="Organized by">   
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">From Date:</label>
                            <div class="col-sm-9">
                                 <input type="date" class="form-control" name="t3" required="required">   
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">To Date:</label>
                            <div class="col-sm-9">
                                 <input type="date" class="form-control" name="t4" required="required">   
                            </div>
                        </div>
                        <div class="form-group row"> 
                           ...
                           <div class="col-sm-9"> 
                               <div class="input-group form-group">
                                  <div class="input-group input-file" name="t5">
                                   <span class="input-group-btn">
                                       <button class="btn btn-info btn-choose" type="button">Choose</button> 
                                   </span>
                                   <input type="text" class="form-control" placeholder="Camp image..."/>
                                    <span class="input-group-btn">
                ...
                //aloow certain file formats
                    if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
                        ...
                        $cn=makeconnection();
                            ...
                            $s="insert into camp(camp_title,organised_by,state,city,fromdate,todate,pic,detail) values('" . $_POST["t1"] ."','" . $_POST["t2"] . "','" . $_POST["s1"] . "','" . $_POST["s2"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . basename($_FILES["t5"]["name"]) . "','" . $_POST["t6"] ."')";
                    mysqli_query($cn,$s);
                    mysqli_close($cn);
            ...
            <div class="col-xl-4 col-lg-5 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Saved Cities</h6>
                </div>
                <div class="card-body">        
