      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Add Advert</a>
          </div>
        </div>
      </li>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-7 col-lg-7 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Add Advert</h6>
                </div>
                <div class="card-body">
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Camp Title:</label>
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t3" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 30 characters" placeholder="Camp">   
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Organized By:</label>
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t2" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 30 characters" placeholder="Organizer">   
                        </div>
                    </div>
                    <div class="form-group row"> 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             <textarea class="form-control" rows="2" name="t4"></textarea>   
                        </div>
                    </div>
            ...
            <div class="col-xl-5 col-lg-5 mb-4">
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Active Adverts</h6>
                </div>
                <div class="card-body">        
