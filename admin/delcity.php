      ...
      <li class="nav-item active">
        ...
        <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Delete City</a>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Delete City</h1>
          </div>
            ...
            <div class="col-xl-8 col-lg-7 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Delete City</h6>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer d-flex justify-content-center">
                 <input type="submit" name="sbmt" value="Delete" class="btn btn-danger">      
                </div>
                </form>
                <?php
                if(isset($_POST["sbmt"]))
