      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Add City</a>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t3" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 30 characters" placeholder="City Name">   
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Code:</label>
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t2" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 10 characters" placeholder="Code">   
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">District:</label>
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t1" required="required" pattern="[a-zA-Z  ]{3,30}" title="A minimum of 3 and maximum of 30 characters" placeholder="District">   
                        </div>
                    </div>
                    <div class="form-group row">
