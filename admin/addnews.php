      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="#">Add News</a>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                             <input type="text" class="form-control" name="t1" required="required" pattern="[a-zA-Z  ]{3,15}" title="A minimum of 3 and maximum of 0 characters" placeholder="News Title">   
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Details:</label>
                        <div class="col-sm-9">
                             <textarea class="form-control" rows="3" name="t2"></textarea>   
                        </div>
                    </div>
                </div>
